...
export default defineConfig(({ mode }) => ({
  ...
  optimizeDeps: {
    ...
    include: ['bs58', 'bn.js', 'js-sha3', 'hash.js', 'bech32', 'fetch-retry', 'eventemitter3', 'canonicalize', '@coinbase/wallet-sdk', 'shallowequal', 'react-dom', 'use-sync-external-store', 'use-sync-external-store/with-selector', '@headlessui/react', '@walletconnect/time', '@walletconnect/relay-auth']
  },
  define: {
    global: 'globalThis',
  },
