...
EnhancedDropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName;
...
EnhancedDropdownMenuSubContent.displayName = DropdownMenuPrimitive.SubContent.displayName;
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-lg border bg-popover/95 backdrop-blur-lg p-1 text-popover-foreground shadow-glow data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        className,
      )}
      {...props}
    />
